...
namespace CVBImageProc.Processing.PixelFilter
{
	...
	internal sealed class AOIViewModel(ICanProcessIndividualRegions processor) : SettingsViewModelBase
	{
		#region Properties
		...
		/// The processor.
		/// </summary>
		private readonly ICanProcessIndividualRegions _processor = processor ?? throw new ArgumentNullException(nameof(processor));
