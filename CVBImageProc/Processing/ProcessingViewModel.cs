...
namespace CVBImageProc.Processing
{
  ...
  class ProcessingViewModel : ViewModelBase, INeedImageInfo
  {
    ...
    /// </summary>
    private Type[] GetSerializerTypes => (AvailableProcessors.Select(p => p.Type).Concat(PixelFilter.IndividualPixelProcessorSettingsViewModel.AvailableFilter.Select(p => p.Type))).ToArray();
