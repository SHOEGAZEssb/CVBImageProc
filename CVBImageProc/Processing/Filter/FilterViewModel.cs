...
namespace CVBImageProc.Processing.Filter
{
	...
	internal sealed class FilterViewModel : FullProcessorViewModelBase
	{
		...
		private SettingsViewModelBase MakeCustomSettingsViewModel()
		{
			...
			return _processor.SelectedFilter switch
			{
				Custom c => new CustomKernelSettingsViewModel(c),
				Median m => new MedianSettingsViewModel(m),
				OilPainting o => new OilPaintingSettingsViewModel(o),
				_ => null,
			};
		}
