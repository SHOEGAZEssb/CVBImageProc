...
namespace CVBImageProc.ImageSource
{
	...
	internal sealed class VideoImageSource(Device device) : IChangingImageSource
	{
		#region Properties
		...
		/// The video device.
		/// </summary>
		private readonly Device _device = device ?? throw new ArgumentNullException(nameof(device));
